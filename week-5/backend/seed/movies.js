  ...
  try {
    ...
    const movies = [
      ...
      },
      {
        ...
        duration_hour: 2,
        duration_minute: 14,
        synopsis: 'Natasha Romanoff, aka Black Widow, confronts the darker parts of her ledger when a dangerous conspiracy with ties to her past arises.'
      },
      {
        ...
        duration_hour: 2,
        duration_minute: 10,
        synopsis: 'Super-assassin John Wick is on the run after killing a member of the international assassin\'s guild, and with a $14 million price tag on his head.'
      },
      {
      ...
      },
      {
        ...
        duration_hour: 2,
        duration_minute: 13,
        synopsis: 'Peter Parker tries to balance high school life with being Spider-Man while facing the Vulture, a new villain who emerges to threaten New York City.'
      },
      {
      ...
      },
      {
        ...
        duration_hour: 1,
        duration_minute: 39,
        synopsis: 'A hotel concierge and his protégé embark on a series of adventures involving the theft and recovery of a priceless Renaissance painting and the battle for an enormous family fortune.'
      },
      {
